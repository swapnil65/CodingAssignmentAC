...
public class MockProductsForTest {
	...
	public Product getSingleProduct() {
		Product product = new Product("2", "1358743283", "7394650110003",
	...
	public List<Product> getAllProducts() {
		...
		Product product2 = new Product("2", "1358743283", "7394650110003",
				"Polo Shirt", new BigDecimal(19.99));
		Product product3 = new Product("3", "1458843283", "7394750120000",
				"Floral Swing Skirt", new BigDecimal(69.99));
		Product product4 = new Product("4", "1358753283", "7394850130001",
				"Denim Short", new BigDecimal(69.99));
		Product product5 = new Product("5", "1258793283", "7394950140000",
				"True Skinny Jeans", new BigDecimal(29.99));
